# ============================================================================
# VEGETABLE QUALITY DETECTION - CNN + XGBoost
# Optimized for CPU with Batch Processing
# Dataset: 6000 images, 10 classes (5 vegetable × 2 conditions)
# ============================================================================
...
print("="*70)
print("VEGETABLE QUALITY DETECTION - HYBRID CNN + XGBoost")
...
def load_dataset(dataset_path):
    ...
    fruits = ['bellpepper', 'carrot', 'cucumber', 'potato', 'tomato']  
...
# ============================================================================
def save_features(X, y, prefix='vegetable_features'):
...
def load_features(prefix='vegetable_features'):
...
def features_exist(prefix='vegetable_features'):
...
def evaluate_model(model, X_test, y_test):
    ...
    plt.title('Confusion Matrix -Vegetable Quality Detection (10 Classes)', 
...
def save_models(xgboost_model, feature_extractor=None):
    ...
    # Save XGBoost
    xgboost_model.save_model('vegetable_quality_xgboost.json')
    print(f"✅ XGBoost model saved: 'vegetable_quality_xgboost.json'")
    
    # Save MobileNetV2 (optional)
    if feature_extractor is not None:
        feature_extractor.save('vegetable_mobilenetv2_feature_extractor.h5')
        print(f"✅ Feature extractor saved: 'vegetable_mobilenetv2_feature_extractor.h5'")
...
def main():
    ...
    if features_exist('vegetable_features'):
        ...
        save_features(X, y, 'vegetable_features')
    ...
    print(f"✅ Model saved: 'vegetable_quality_xgboost.json'")
    print(f"✅ Features saved: 'vegetable_features_X.npy', 'vegetable_features_y.npy'")
...
def load_and_predict(image_path):
    ...
    feature_extractor = tf.keras.models.load_model('vegetable_mobilenetv2_feature_extractor.h5')
    
    # Load XGBoost
    xgboost_model = xgb.XGBClassifier()
    xgboost_model.load_model('vegetable_quality_xgboost.json')
...
load_and_predict('test_images/test_image14.png')
