...
IMG_HEIGHT = 224
IMG_WIDTH = 224
FEATURE_EXTRACTOR_PATH = "vegetable_mobilenetv2_feature_extractor.h5"
XGB_MODEL_PATH = "vegetable_quality_xgboost.json"
...
def calculate_rating(predicted_class, confidence):
    ...
    Logic:
    - Rotten Vegetable: 0 stars (rejected, do not consume)
    - Fresh Vegetable: 1-5 stars based on confidence
...
def main():
    ...
    print("\n" + "=" * 70)
    print("🥔 VEGETABLE QUALITY DETECTION – PREDICTION WITH RATING")
    print("=" * 70)
    ...
    if rating == 0:
        if predicted_class.startswith('rotten'):
            print("\n⚠️  ALERT: This vegetable is ROTTEN and should NOT be consumed.")
